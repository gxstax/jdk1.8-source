...
public final class DGCImpl_Stub
    ...
    public void clean(java.rmi.server.ObjID[] $param_arrayOf_ObjID_1, long $param_long_2, VMID $param_VMID_3, boolean $param_boolean_4)
    ...
    public Lease dirty(java.rmi.server.ObjID[] $param_arrayOf_ObjID_1, long $param_long_2, Lease $param_Lease_3)
            throws java.rmi.RemoteException {
        try {
