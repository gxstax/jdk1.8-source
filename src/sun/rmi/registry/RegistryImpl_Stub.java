...
public final class RegistryImpl_Stub
    ...
    public void bind(String $param_String_1, java.rmi.Remote $param_Remote_2)
    ...
    public java.rmi.Remote lookup(String $param_String_1)
    ...
    public void rebind(String $param_String_1, java.rmi.Remote $param_Remote_2)
            throws java.rmi.AccessException, java.rmi.RemoteException {
        try {
    ...
    public void unbind(String $param_String_1)
            throws java.rmi.AccessException, java.rmi.NotBoundException, java.rmi.RemoteException {
        try {
