...
abstract class MessageToken extends Krb5Token {
    ...
    */
    ...
    class MessageTokenHeader {
         ...
         * @return the token id
         * @see Krb5Token#MIC_ID
         * @see Krb5Token#WRAP_ID
         */
        public final int getTokenId() {
            return tokenId;
        }
         ...
         * @see MessageToken#SIGN_DES_MAC
         * @see MessageToken#SIGN_DES_MAC_MD5
         */
         ...
         * @see MessageToken#SEAL_ALG_DES
         * @see MessageToken#SEAL_ALG_NONE
         */
