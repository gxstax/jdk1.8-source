        ...
        extends ConnectorImpl implements ListeningConnector
{
                                      ...
                                      boolean addAddressArgument)
    {
        ...
        listenMap = new HashMap<Map<String,? extends Argument>,TransportService.ListenKey>(10);
    }
    ...
    public String startListening(String address, Map<String,? extends Argument> args)
    ...
    public VirtualMachine
        accept(Map<String,? extends Argument> args)
        throws IOException, IllegalConnectorArgumentsException
    {
