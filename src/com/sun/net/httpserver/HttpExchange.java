 ...
 * <li>{@link #getRequestBody()} returns a {@link InputStream} for reading the request body.
 ...
 * next step.
 * <li>{@link #getResponseBody()} to get a {@link OutputStream} to send the response body.
...
public abstract class HttpExchange {
     ...
     * return the given {@link InputStream}, and calls to
     * {@link #getResponseBody()} will return the given
     * {@link OutputStream}. The streams provided to this
     * call must wrap the original streams, and may be (but are not
     * required to be) sub-classes of {@link FilterInputStream}
     * and {@link FilterOutputStream}.
