 ...
 * {@link Integer#TYPE Integer.TYPE})
    ...
    extends Type, Comparable<ReferenceType>, Accessible
{
     ...
     * represented by {@link Integer#TYPE Integer.TYPE}.
     ...
     * @throws IllegalArgumentException if the field is not valid for
     * this object's class.
     */
     ...
     * their {@link Value}.
     * @throws IllegalArgumentException if any field is not valid for
     * this object's class.
     ...
     * lineNumber)</code> -
     * see {@link
     * #locationsOfLine(String, String,int)}
     * for more information.
     *
     ...
     * @throws IllegalArgumentException if maxInstances is less
     *         than zero.
     * @since 1.6
     */
