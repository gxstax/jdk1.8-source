...
public interface ClassType extends ReferenceType {
     ...
     * See {@link ReferenceType#methodsByName(String, String)}
     ...
     * @see ReferenceType#methodsByName(String name)
     * @see ReferenceType#methodsByName(String name, String signature)
