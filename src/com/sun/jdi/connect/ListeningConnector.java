...
public interface ListeningConnector extends Connector {
     ...
     * of {@link Argument}. The default argument map for a
     ...
     * for a connection.
     * @throws IOException when unable to start listening.
     ...
     */
    String startListening(Map<String, ? extends Argument> arguments)
     ...
     *
     * @throws IOException when unable to stop listening.
     * Specific exceptions are dependent on the Connector implementation
     * in use.
     * @throws IllegalConnectorArgumentsException when one of the
     * connector arguments is invalid.
     */
    void stopListening(Map<String, ? extends Argument> arguments)
        throws IOException, IllegalConnectorArgumentsException;
     ...
     * {@link Argument} representing a timeout has been set
     * in the argument map, and a timeout occurs whilst waiting for
     * the target VM to connect.
     * @throws IOException when unable to accept.
     * Specific exceptions are dependent on the Connector implementation
     * in use.
     * @throws IllegalConnectorArgumentsException when one of the
     * connector arguments is invalid.
     */
    VirtualMachine accept(Map<String, ? extends Argument> arguments)
        throws IOException, IllegalConnectorArgumentsException;
