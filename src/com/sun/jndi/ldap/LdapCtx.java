...
final public class LdapCtx extends ComponentDirContext
    ...
    Hashtable<String, Object> envprops = null; // environment properties of context
    ...
    public LdapCtx(String dn, String host, int port_number,
        ...
        if (props != null) {
            envprops = (Hashtable<String, Object>) props.clone();
   ...
   // --------------------- Searches -----------------------------
    ...
    NamingEnumeration<SearchResult> searchAux(Name name,
        ...
        SearchArgs args =
            new SearchArgs(name, filter, cons, reqAttrs);
