...
public class CNCtx implements Context {
    ...
    Hashtable<String, Object> _env; // used by ExceptionMapper
    ...
    CNCtx(Hashtable<?,?> env) throws NamingException {
        ...
        _env = (Hashtable<String, Object>)env;
    ...
    throws NamingException {
        ...
        ctx._env = (Hashtable<String, Object>)env;
    ...
    CNCtx(ORB orb, OrbReuseTracker tracker, NamingContext nctx,
          Hashtable<String, Object> env, NameComponent[]name)
        throws NamingException {
    ...
    private void initOrbAndRootContext(Hashtable<?,?> env) throws NamingException {
        ...
        String provUrl = null;
        if (env != null) {
            provUrl = (String)env.get(Context.PROVIDER_URL);
        }
...
"COS Name Service not registered with ORB under the name 'NameService'");
    ...
    public Object lookup(Name name)
        throws NamingException {
            ...
            try {
                ...
                Context cctx = getContinuationContext(cpe);
    ...
    public  void bind(Name name, Object obj)
        throws NamingException {
            ...
            try {
                ...
                Context cctx = getContinuationContext(e);
    ...
    static private Context
        ...
        try {
            ...
            if (resObj instanceof Reference) {
                ...
                if (addr.getContent() instanceof Context) {
    ...
    /**
      ...
      */
    private Context callBindNewContext(NameComponent[] path)
        throws NamingException {
            if (_nc == null)
                throw new ConfigurationException(
                    "Context does not have a corresponding NamingContext");
    ...
    public  Hashtable<String, Object> getEnvironment() throws NamingException {
        if (_env == null) {
            ...
            return (Hashtable<String, Object>)_env.clone();
        }
    }
    ...
    public Object addToEnvironment(String propName,
        ...
        throws NamingException {
            if (_env == null) {
                ...
                // copy-on-write
                _env = (Hashtable<String, Object>)_env.clone();
            }
